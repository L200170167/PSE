	...
	die();
			...
			?>
			   ...
			   <tr>
				...
				<td>
				<!-- -->
<select  class=' selectpicker' data-live-search='true'   required="required" type="text" name="nik" id="nik" placeholder="Nik" value="<?php echo ($data['nik']); ?>">
<option value='<?php echo $data[nik];?>'>- <?php echo $data[nik];?> -</option><?php combo_database2('data_karyawan','nik','nama',''); ?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input onkeypress='return h(event)' class=''   required="required" type="text" name="nama_tunjanagn" id="nama_tunjanagn" placeholder="Nama&nbsp;Tunjanagn" value="<?php echo ($data['nama_tunjanagn']); ?>">
