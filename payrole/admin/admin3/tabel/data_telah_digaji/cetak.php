...
{   
	...
	<?php
	action_cetak("data_telah_digaji"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_telah_digaji");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;telah&nbsp;digaji</th>
        <th class="th_border cell"  >nama</th>
<th class="th_border cell"  >jumlah&nbsp;gaji</th>
<th class="th_border cell"  >jumlah&nbsp;tunjangan</th>
<th class="th_border cell"  >total</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_telah_digaji where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_telah_digaji where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_telah_digaji";
				}
