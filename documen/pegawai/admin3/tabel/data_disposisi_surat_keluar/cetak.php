...
{   
	...
	<?php
	action_cetak("data_disposisi_surat_keluar"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_disposisi_surat_keluar");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
        ...
        <td class="auto-style2">
            <center>
                <strong>LAPORAN
                    ...
                    <?php
			$tabelnya = "data_disposisi_surat_keluar";
...
<th class="th_border cell"  >status</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_disposisi_surat_keluar where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_disposisi_surat_keluar where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_disposisi_surat_keluar";
				}
...
<td align="center"><?php echo baca_database("", "perihal", " select * from data_surat_keluar=no_surat where nomor_surat ='$data[nomor_surat]'") ?></td>
<td align="center"><?php echo ($data['disposisi_dari']); ?></td>
<td align="center"><?php echo baca_database("", "nama", " select * from data_pegawai=NIP where disposisi_dari ='$data[disposisi_dari]'") ?></td>
