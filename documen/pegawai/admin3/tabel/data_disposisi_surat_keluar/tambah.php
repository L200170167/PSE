...
$id = $_COOKIE['nip'];
$id = decrypt("$id")?>
<select  class=' selectpicker' data-live-search='true'  type="text" name="proses" id="nomor_surat" placeholder="Nomor&nbsp;Surat" required="required">
		...
		if ($_GET['proses'])
{
		...
		<a href="../../../../admin/upload/<?php echo $gambar; ?>">
<img width="400"  onerror="this.src='<?php echo $imageerror; ?>'" src="../../../../admin/upload/<?php echo $gambar; ?>">
<br>
<br>
...
<option></option>
<?php combo_database2('data_pegawai','NIP','nama',''); ?>
<?php combo_database2('data_admin','id_admin','username',''); ?>
</select>		
