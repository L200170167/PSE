...
<body>
	...
	<a target="blank" href="cetak.php?berdasarkan=data_disposisi&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_export('Export Excel'); ?>
	</a>
	
	<a target="blank" href="cetak.php?berdasarkan=data_disposisi&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_cetak('Cetak'); ?>
	</a>
...
<th align="center" class="th_border cell"  >Status</th>
			...
			<?php
				...
				$querytabel="SELECT * FROM data_disposisi where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_disposisi where $berdasarkan like '%$isi%'";
				}
				else
				{
				$querytabel="SELECT * FROM data_disposisi  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_disposisi";
				}
               ...
               <tr class="event2">	
                 ...
                 <td align="center"><?php echo (substr($data['nomor_surat'],0,100)); ?></td>
<td align="center"><?php echo (substr($data['disposisikan_kepada'],0,100)); ?></td>
