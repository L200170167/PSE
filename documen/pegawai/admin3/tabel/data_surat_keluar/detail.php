...
where nomor_surat='$proses' ") or die (mysql_error());
			...
			$sql=mysql_query("SELECT * FROM data_surat_keluar where no_surat = '$proses'");
...
<tr>
				...
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['tanggal_surat_keluar']; ?></td>	
			   </tr>
<tr>
...
<tr>
				...
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['perihal']; ?></td>	
			   </tr>
<tr>
