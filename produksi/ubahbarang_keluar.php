...
$ambil=$koneksi->query("SELECT * FROM barang_keluar WHERE id_keluar='$id_keluar'");
...
<form method="post" action='ubahbarang_keluar.php'>
<input type="hidden" name="id" class="form-control" value="<?php echo $pecah['id_keluar']; ?>">
    ...
    if (isset($_POST['ubah']))
        {
            ...
            $query = "UPDATE barang_keluar SET kain='$_POST[kain]',panjang='$_POST[panjang]',lebar='$_POST[lebar]',tanggal='$_POST[tanggal]',jumlah='$_POST[jumlah]',satuan='$_POST[satuan]' WHERE id_keluar='$_POST[id]'";
