...
<select  class=' selectpicker' data-live-search='true'  type="text" name="nik" id="nik" placeholder="Nik" required="required">
<option></option><?php combo_database2('data_karyawan','nik','nama',''); ?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input onkeypress='return h(event)' class=''  type="text" name="nama_tunjanagn" id="nama_tunjanagn" placeholder="Nama&nbsp;Tunjanagn" required="required">
