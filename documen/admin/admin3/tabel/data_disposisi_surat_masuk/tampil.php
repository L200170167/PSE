...
<body>
	...
	<a target="blank" href="cetak.php?berdasarkan=data_disposisi_surat_masuk&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_export('Export Excel'); ?>
	</a>
	
	<a target="blank" href="cetak.php?berdasarkan=data_disposisi_surat_masuk&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_cetak('Cetak'); ?>
	</a>
					...
					<table>
						...
						<tr>
							...
							<!-- <input value="" name="Berdasarkan" id="Berdasarkan" > --> <select class="form-control selectpicker" data-live-search="true" name="Berdasarkan" id="Berdasarkan">
								<?php
								$sql = "desc data_disposisi_surat_masuk";
...
<th align="center" class="th_border cell"  >Status</th>
			...
			<?php
				...
				$querytabel="SELECT * FROM data_disposisi_surat_masuk where $berdasarkan like '%$isi%' and disposisi_dari='$id' order by id_pegawai DESC  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_disposisi_surat_masuk where $berdasarkan like '%$isi%' and disposisi_dari='$id'";
				}
				else
				{
				$querytabel="SELECT * FROM data_disposisi_surat_masuk where disposisi_dari='$id'  order by id_pegawai DESC   LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_disposisi_surat_masuk where disposisi_dari='$id'";
				}
