	...
	die();
			...
			?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input class=''   required="required" type="date" name="tanggal_surat_masuk" id="tanggal_surat_masuk" placeholder="Tanggal&nbsp;Surat&nbsp;Masuk" value="<?php echo ($data['tanggal_surat_masuk']); ?>">
...
<?php echo $data['lampiran']?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<textarea class='ckeditor'    required="required" type="text" name="prihal" id="prihal" placeholder="Prihal" value="<?php echo ($data['prihal']); ?>">
