...
<body>
	...
	<a target="blank" href="cetak.php?berdasarkan=data_surat_keluar&jenis=xls&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_export('Export Excel'); ?>
	</a>
	
	<a target="blank" href="cetak.php?berdasarkan=data_surat_keluar&jenis=print&pakaiperperiode=<?php echo $status_pakaiperperiode;?>">
	<?php btn_cetak('Cetak'); ?>
	</a>
...
<br><br>
	<center>
	<h3>DAFTAR SURAT KELUAR YANG <br> ANDA BUAT</h3>
	</center>
	<br>
...
<th align="center" class="th_border cell"  >Perihal</th>
...
<th align="center" class="th_border cell"  >File&nbsp;surat</th>
			...
			<?php
				...
				$querytabel="SELECT * FROM data_surat_keluar where $berdasarkan like '%$isi%' and pembuat_surat='$id' order by id_surat_keluar DESC   LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_surat_keluar where $berdasarkan like '%$isi%' and pembuat_surat='$id'";
				}
				else
				{
				$querytabel="SELECT * FROM data_surat_keluar where pembuat_surat='$id' order by id_surat_keluar DESC   LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_surat_keluar where pembuat_surat='$id'";
				}
				  ...
				  <td class="th_border cell" align="center" width="200">
						<table border="0">
							<tr>
								...
								<td>
									<a href="<?php index(); ?>?input=edit&proses=<?= encrypt($data['id_surat_keluar']); ?>">
									<?php btn_edit('Edit'); ?></a>
								</td>
								<td>
									<a href="<?php index(); ?>?input=hapus&proses=<?= encrypt($data['id_surat_keluar']); ?>">
...
<td align="center"><a href='../../../../admin/upload/<?php echo $data['file_surat']; ?>'><img onerror="this.src='<?php echo $imageerror; ?>'" width='50' height='30' src='../../../../admin/upload/<?php echo $data['file_surat']; ?>'></a></td>
