...
<option value='<?php echo $data[nomor_surat];?>'>- <?php echo $data[nomor_surat];?> -</option><?php combo_database2('data_surat_masuk','no_surat','prihal',''); ?>
</select>
...
<option value='<?php echo $data[status];?>'>- <?php echo $data[status];?> -</option><?php combo_enum('data_disposisi_surat_masuk','status',''); ?>
</select>
