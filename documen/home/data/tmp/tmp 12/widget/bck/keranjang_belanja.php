...
<table class="table">
	...
	<td>:</td>
	<td>
		<input required value="<?php echo baca_session("no_telepon");?>"  name="no_telepon_penerima" type="number">
	</td>
	</tr>
	...
	<td>:</td>
	<td>
		<input value="<?php echo baca_session("nama_pelanggan");?>" required name="nama_penerima" id="nama_penerima" >
	</td>
	</tr>
</table>
</div>
