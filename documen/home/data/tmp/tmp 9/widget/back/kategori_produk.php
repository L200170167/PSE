						 ...
						 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="admin/upload/<?php echo $data["$foto"];?>" alt="" width="150" height="180" class="pro-image-front">
										<img src="admin/upload/<?php echo $data["$foto"];?>" alt="" width="150" height="180" class="pro-image-back">
