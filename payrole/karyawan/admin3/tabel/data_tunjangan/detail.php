...
if (!isset($_GET['proses']))
{
	...
	die();
			...
			?>
			   <tr>
				<td class="clleft" width="25%">id&nbsp;tunjangan</td>
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['id_tunjangan']; ?></td>	
			   </tr>
...
<tr>
				<td class="clleft" width="25%">nama&nbsp;tunjanagn</td>
				<td class="clleft" width="2%">:</td>
				<td class="clleft"><?php echo $data['nama_tunjanagn']; ?></td>	
			   </tr>
<tr>
