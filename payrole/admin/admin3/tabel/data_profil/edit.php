	...
	die();
			...
			?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<textarea class='ckeditor'    required="required" type="text" name="tentang_perusahaan" id="tentang_perusahaan" placeholder="Tentang&nbsp;Perusahaan" value="<?php echo ($data['tentang_perusahaan']); ?>">
<?php echo $data['tentang_perusahaan']?>
</textarea>
