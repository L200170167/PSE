...
{   
	...
	<?php
	action_cetak("data_pembagian_gaji"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_pembagian_gaji");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;pembagian&nbsp;gaji</th>
        <th class="th_border cell"  >jabatan</th>
<th class="th_border cell"  >sistem&nbsp;perhitungan&nbsp;gaji</th>
<th class="th_border cell"  >gaji</th>
<th class="th_border cell"  >potongan&nbsp;uang&nbsp;makan&nbsp;harian</th>
<th class="th_border cell"  >potongan&nbsp;tidak&nbsp;masuk&nbsp;kerja</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_pembagian_gaji where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_pembagian_gaji where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_pembagian_gaji";
				}
