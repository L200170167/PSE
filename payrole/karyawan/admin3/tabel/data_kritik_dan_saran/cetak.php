...
{   
	...
	<?php
	action_cetak("data_kritik_dan_saran"); 
}
else
{
	include '../../../include/all_include.php';
	proses_action_cetak("data_kritik_dan_saran");
?>
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
	<link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
        ...
        <td class="auto-style2">
            <center>
                <strong>LAPORAN
                    ...
                    <?php
			$tabelnya = "data_kritik_dan_saran";
...
<table width="100%"  class="tblcms2">
    <tr>
        ...
        <th class="th_border cell">id&nbsp;kritik&nbsp;dan&nbsp;saran</th>
        <th class="th_border cell"  >nama&nbsp;karyawan</th>
<th class="th_border cell"  >kritik&nbsp;dan&nbsp;saran</th>
    ...
    <?php
				...
				if (isset($_GET['isi']) && !empty($_GET['isi']))
				{
					...
					$querytabel="SELECT * FROM data_kritik_dan_saran where $Berdasarkan like '%$isi%'";
				}
				else if (isset($_GET['tanggal1']) && !empty($_GET['tanggal1']))
				{
					...
					$querytabel="SELECT * FROM data_kritik_dan_saran where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
				
				}
				else
				{
					//SEMUA
					$querytabel="SELECT * FROM data_kritik_dan_saran";
				}
