...
<table <?php tabel_in(100,'%',0,'center');  ?>>		
	<tbody>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input  class='' value="<?php echo tanggal_otomatis(); ?>"  type="date" name="tanggal_surat_masuk" id="tanggal_surat_masuk" placeholder="Tanggal&nbsp;Surat&nbsp;Masuk" required="required">
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<textarea class='ckeditor'  type="text" name="prihal" id="prihal" placeholder="Prihal" required="required">
