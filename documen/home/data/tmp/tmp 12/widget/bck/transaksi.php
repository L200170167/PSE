...
<form action="proses_simpan.php" enctype="multipart/form-data"  method="post">
				...
				<input type="hidden" readonly value="<?php echo $idproduknya."-".$kodenya;?>" name="id_komentar" placeholder="id_komentar" id="id_komentar" required="required">		
				
				<input type="hidden" value="<?php echo $idproduknya;?>" name="id_produk" id="id_produk" placeholder="id&nbsp;produk" required="required">

		
				<input type="hidden" value="<?php echo baca_session("id");?>" name="id_pelanggan" id="id_pelanggan" placeholder="id&nbsp;pelanggan" required="required">
						...
						<table border="0">
							<tr>
								...
								else
								{
									...
									<a href="proses_hapus.php?proses=<?php echo $kodenya; ?>">
