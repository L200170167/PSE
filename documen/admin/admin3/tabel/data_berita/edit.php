	...
	die();
			...
			?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input  required="required" type="date" name="tanggal" id="tanggal" placeholder="Tanggal" value="<?php echo $data['tanggal']; ?>">
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input  required="required" type="text" name="judul" id="judul" placeholder="Judul" value="<?php echo $data['judul']; ?>">
			   ...
			   <tr>
				...
				<br>
				<input   type="file" name="foto" id="foto" placeholder="Foto" value="<?php echo $data['foto']; ?>">
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input  required="required" type="text" name="isi" id="isi" placeholder="Isi" value="<?php echo $data['isi']; ?>">
