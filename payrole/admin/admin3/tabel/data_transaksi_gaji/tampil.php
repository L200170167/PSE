...
<th align="center" class="th_border cell"  >Jumlah&nbsp;makan&nbsp;harian</th>
<th align="center" class="th_border cell"  >Jumlah&nbsp;potongan&nbsp;uang&nbsp;makan&nbsp;harian</th>
<th align="center" class="th_border cell"  >Jumlah&nbsp;tidak&nbsp;masuk&nbsp;kerja</th>
<th align="center" class="th_border cell"  >Jumlah&nbsp;potongan&nbsp;tidak&nbsp;masuk&nbsp;kerja</th>
<th align="center" class="th_border cell"  >Jumlah&nbsp;gaji</th>
			...
			<?php
				...
				$querytabel="SELECT * FROM data_transaksi_gaji where $berdasarkan like '%$isi%'  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_transaksi_gaji where $berdasarkan like '%$isi%'";
				}
				else
				{
				$querytabel="SELECT * FROM data_transaksi_gaji  LIMIT $startRow ,$dataPerPage";
				$querypagination="SELECT COUNT(*) AS total FROM data_transaksi_gaji";
				}
...
<td align="center"><?php echo rupiah($data['jumlah_potongan_uang_makan_harian']); ?></td>
<td align="center"><?php echo ($data['jumlah_tidak_masuk_kerja']); ?></td>
<td align="center"><?php echo rupiah($data['jumlah_potongan_tidak_masuk_kerja']); ?></td>
