...
<center>
			<h2> DAFTAR SURAT MASUK YANG <br>
DI DISPOSISIKAN KEPADA ANDA</h2>
</center>
				  ...
				  <td class="th_border cell" align="center" width="200">
						<table border="0">
							<tr>
								...
								<td>
									<a href="<?php index(); ?>?input=tambah&proses=<?= encrypt($data['nomor_surat']); ?>">
...
<center>
			<h2> DAFTAR SURAT MASUK YANG 
			<br>
ANDA DISPOSISIKAN</h2>
</center>
<div style="overflow-x:auto;">
<table <?php tabel(100,'%',1,'left');  ?> >
			<tr>
...
<th align="center" class="th_border cell"  >Status</th>
			...
			<?php
				...
				{
				$querytabel="SELECT * FROM data_disposisi_surat_masuk where disposisi_dari='$id'  order by id_pegawai DESC  ";
