...
<?php echo rupiah(baca_database("data_pembagian_gaji","gaji","select * from data_pembagian_gaji where jabatan='$jabatan'"))?>
				...
				<td width="2%">:</td>
				<td>
				<input class='' readonly value="<?php echo baca_database("data_pembagian_gaji","potongan_uang_makan_harian","select * from data_pembagian_gaji where jabatan='$jabatan'")?>" type="hidden" name="potongan_uang_makan_harian" id="potongan_uang_makan_harian" placeholder="Gaji" required="required">
<?php echo rupiah(baca_database("data_pembagian_gaji","potongan_uang_makan_harian","select * from data_pembagian_gaji where jabatan='$jabatan'"))?>/Hari
			   ...
			   <tr>
				<td width="25%" class="leftrowcms">					
				<label >Jumlah Hari Makan<span class="highlight"></span></label>
			   </td>
				<td width="2%">:</td>
				<td>
				<input class='' onclick="hitung()" onkeydown="hitung()" onkeypress="hitung()" onchange="hitung()" onkeyup="hitung()" min="0" max="30" value="0"   type="number" name="jumlah_makan" id="jumlah_makan" placeholder="jumlah_makan" required="required">
Hari
				...
				<td width="2%">:</td>
				<td>
				<input class='' readonly value="<?php echo baca_database("data_pembagian_gaji","potongan_tidak_masuk_kerja","select * from data_pembagian_gaji where jabatan='$jabatan'")?>" type="hidden" name="potongan_tidak_masuk_kerja" id="potongan_tidak_masuk_kerja" placeholder="Gaji" required="required">
<?php echo rupiah(baca_database("data_pembagian_gaji","potongan_tidak_masuk_kerja","select * from data_pembagian_gaji where jabatan='$jabatan'"))?>/Hari
		
				</td>
			   </tr>
			     <tr>
				<td width="25%" class="leftrowcms">					
				<label >Jumlah Tidak Masuk Kerja<span class="highlight"></span></label>
			   </td>
				<td width="2%">:</td>
				<td>
				<input class='' onclick="hitung()" onkeydown="hitung()" onkeypress="hitung()" onchange="hitung()" onkeyup="hitung()" min="0" max="30" value="0" type="number" name="tidak_masuk_kerja" id="tidak_masuk_kerja" placeholder="tidak_masuk_kerja" required="required">
Hari
...
<?php echo (baca_database("data_pembagian_gaji","sistem_perhitungan_gaji","select * from data_pembagian_gaji where jabatan='$jabatan'"))?>
			   ...
			   <tr>
				...
				<td width="2%">:</td>
				<td>
				<input value="1" class='' onclick="hitung()" onkeydown="hitung()" onkeypress="hitung()" onchange="hitung()" onkeyup="hitung()" type="text" name="jumlah_perhitungan" id="jumlah_perhitungan" placeholder="Jumlah&nbsp;Perhitungan" required="required">

		<?php $s =  (baca_database("data_pembagian_gaji","sistem_perhitungan_gaji","select * from data_pembagian_gaji where jabatan='$jabatan'"));
...
<script src="../../../data/cssjs/jquery/jquery.js"></script>
	<script>
				 ...
				 var tidak_masuk_kerja = $("#tidak_masuk_kerja").val();
				 var jumlah_makan = $("#jumlah_makan").val();
				 var potongan_tidak_masuk_kerja = $("#potongan_tidak_masuk_kerja").val();
				 var potongan_uang_makan_harian = $("#potongan_uang_makan_harian").val();
				 
				 var total_tidak_kerja = tidak_masuk_kerja * potongan_tidak_masuk_kerja;
				 var total_makan = jumlah_makan * potongan_uang_makan_harian;
				 
				 var total = (gaji*jumlah_perhitungan) - (total_makan + total_tidak_kerja);
